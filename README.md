...
| waveFormFilePath          | -           | ✅              | ❌            | string                                                     | Absolute file path where to read from or save to the extracted waveform data in JSON format. Recommendation: use the system `Cache` folder.                                                                                                      |
